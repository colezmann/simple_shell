# shellby - The Simple Shell

A simple UNIX command interpreter adopted for the Software Engineering programme at ALX.
...
Example:
```
$ echo "echo 'hello' #this sentence will be ignored!" | ./shellby
'hello'
```
